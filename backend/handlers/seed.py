...
EXERCISES = [
    ...
    ("Calf Raises", "legs", None, False, False, None, 120, []),
    # Replacement-only exercises (not in plan but available as swaps)
...
PLAN_DAYS = [
    (1, "Upper A", [
        ("DB Incline Chest Press", 2, "4-8", "working"),
        ("Weighted Pull Up", 2, "4-8", "working"),
        ("Weighted Dips", 2, "4-8", "working"),
        ("Lateral Raise Pulley", 2, "8-12", "working"),
        ("Tricep Pushdown Pulley Uni", 2, "5-8", "working"),
    ]),
    (2, "Lower A", [
        ("Deadlift", 2, "4-8", "working"),
        ("Zercher Squat", 2, "4-8", "working"),
        ("Leg Press 45", 2, "4-8", "working"),
        ("Seated Leg Curl", 2, "4-8", "working"),
        ("Adductor Machine", 2, "4-8", "working"),
    ]),
    (3, "Upper B", [
        ("Barbell OHP", 2, "4-8", "working"),
        ("Strict Row BB", 2, "4-8", "working"),
        ("DB Chest Press", 2, "4-8", "working"),
        ("Lat Pulldown", 2, "4-8", "working"),
        ("Rear Delt Fly Machine", 2, "4-8", "working"),
        ("Bicep Curl EZ Bar", 2, "4-8", "working"),
    ]),
    (4, "Lower B", [
        ("Hack Squat", 2, "4-8", "working"),
        ("Hip Thrust Machine", 2, "4-8", "working"),
        ("Leg Extension Uni Machine", 2, "4-8", "working"),
        ("Laying Leg Curl", 2, "4-8", "working"),
        ("Calf Raises", 2, "8-12", "working"),
    ]),
]
